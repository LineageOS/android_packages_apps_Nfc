...
public class NativeNfcManager implements DeviceHost {
    ...
    private final boolean mExtendedLengthApdusSupported;
    ...
    public NativeNfcManager(Context context, DeviceHostListener listener) {
        ...
        mExtendedLengthApdusSupported = mContext.getResources()
                .geBoolean(R.bool.config_extended_length_apdus_supported);
    }
    ...
    public boolean getExtendedLengthApdusSupported() {
        return mExtendedLengthApdusSupported;
    }
